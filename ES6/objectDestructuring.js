...
console.log(`Name is ${myname} age is ${myage} lives in ${mycity} and interests ${fav.one} ${fav.two}`) //Name is vaishnav age is 23 lives in hyderabad and interests cars movies
